...
// batch reindex reconciles. A non-canonical repost or a closed job is never made searchable,
// matching cmd/reindex and cmd/search-drain. Category resolution and a complete description
// improve a result but cannot hide a real imported vacancy from the exhaustive catalogue.
